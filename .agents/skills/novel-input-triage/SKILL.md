...
description: 中文网文输入分流技能。用于处理作者随手灵感、正文片段、章节正稿、人设、世界观、设定、大纲、留白、文风反馈、废案、读者反馈或 AI 稿反馈，识别输入类型、权威等级、目标范围和确认需求；不用于生成正文或写入正史。
---
...
分流时特别识别：人设、爽点、毒点、追读、章末钩子、伏笔、留白、CP 线、圆场、AI 味、读者反馈、废案复活。
