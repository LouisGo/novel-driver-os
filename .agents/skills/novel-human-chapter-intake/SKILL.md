...
description: Chapter Intake / 人工章节接入；用于作者亲写正文、章节正稿或正文片段，提取 fact_delta、人物状态、伏笔钩子、连续性问题，并可做章节质量审稿；不润色、不改写、不组装完整 capsule。
---
...
- 任何完整章节、开篇、章末或 variant 胜出稿都必须读 `references/chapter-quality-rubric.md`。
...
4. 识别中文网文和通用商业叙事层面的追读点、毒点、章末钩子、爽点承诺、情绪曲线和工业味风险。
5. 如进行质量审稿，按 Rubric 评分：主角锚定、开篇吸引、目标压力行动链、爽点、钩子阶梯、信息投放、人味、AI 味、毒点、长篇可持续性。
6. 所有推断标注 confidence 和是否需要确认。

## 输出

生成接入报告；不生成完整创作接入胶囊。字段与 `references/intake-output.md` 保持一致：
...
- 不生成 `memory_patch.yaml` 十件套；完整 capsule 交给 `novel-creative-intake-capsule`。

## 自检

- 新事实是否具体到人物、行为、地点、物件？
- 是否保留原文证据句？
- 是否没有输出“作者提交了正文”这种空事实？
