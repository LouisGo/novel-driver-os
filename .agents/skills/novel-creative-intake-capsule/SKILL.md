...
description: 中文网文创作接入胶囊技能。用于把作者正文或重要片段生成完整 创作接入胶囊，包括 fact_delta、氛围三角、意图假设、冲突注脚、圆场债务候选、文风候选、memory_patch 和对齐问题；不定稿、不入正史。
---
...
4. 意图假设分 L1/L2/L3；L2 和 L3 必须有限 TTL。
5. 记忆补丁 只写 提案，等待作者确认。
